# JavaScript Foundations Originals
Original Javascript foundations, feel free to fork the project to practice your JavaScript Fundamental's  
I got this from Turing School of Software and Design back when I was apart of the 2110FE Cohort 
...
2. Type `cd javascript-foundations-originals` to move into the root directory
3. Run `npm install`
...
```shell
> foundations@1.0.0 test /Users/RosaTheDev/turing/frontend/mod1/javascript-foundations-originals
> mocha "mythical-creatures/test/unicorn-test.js"
  ...
  Unicorn
    ...
    - should have a name
    - should have a color
    - should be Black as default
    - should refute isBlack
...
- [ ] Want to track your progress? First, make sure you're on a froked version of this repo. Then, you can edit the README and change `[ ]` to `[x]` on the suites you've completed!
