...
describe('Centaur', function() {
    ...
    it.skip('should have a name', function() {
        ...
        // NOTE: We will not ask you to write our own tests in a mod 1 assessment, but it is good practice to prepare for mod 2!
    });
    ...
    it.skip('should have a horse sound when it runs', function() {
        var centaur = new Centaur({ name: 'Georgina', type: 'Palomino'});

        var soundEffect = centaur.run();

        assert.equal(soundEffect, 'clop clop clop!!!');
    });
    ...
    it.skip('should not be cranky after sleeping', function() {
        ...
        assert.equal(centure.shootBow(), 'Twang!!!');
    });

    it.skip('should not be crankey after drinking potion', function() {
        var centaur = new Centaur({ name: 'Georgiana', type: 'Palomino' });
