...
describe('Direwolf', function() {
    ...
    it.skip('should instantiate our goof friend, Direwolf', function() {
    ...
    it.skip('should be able to have a other size', function() {
    ...
    it.skip('should have a default locaton of Winterfell', function() {
        const stark = new Stark({name: 'Bran'});
    ...
    it.skip('should be able to have different locatons', function() {
    ...
    it.skip('should only be able to protect a Stark if direwolf and Start locations match', function() {
        const direwolf = new Direwolf('Ghost');
