...
describe('Fairy', () => {
    ...
    it.skip('should have a name', () => {
        // instantiate a Fairy object with your name as the argument
    ...
    it.skip('should get a small amount of fairy dust when others belive in her', () => {
    ...
    it.skip('should turn flowers into more dresses', () => {
        ...
        fairy.makeDresses(['Daffodil', 'Trulip', 'Poppy']);
