...
describe('Medusa', function() {
    ...
    it.skip('should have a name', function() {
        ...
        // NOTE: we will not ask you to write your own test in a mod1 assessment, but it is good practice to prepare you for mod2!
    });

    it.skip('should start wit no statues', function() {
    ...
    it.skip('should return a freed statue to a Person form', function() {
        var medusa = new Medusa('Hannah');
        var victim1 = new Person('Pam');
        var victim2 = new Person('Khalid');
        var victim3 = new Person('Scott');
    ...
    it.skip('should be relived when returned to Person form', function() {
        ...
        assert.equal(person.mood, 'relived');
    });
});
