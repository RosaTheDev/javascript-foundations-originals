...
describe('Pirate', function () {
    ...
    it.skip('should have a name', function () {
        ...
        var chendISao = new Pirate('Cheng I Sao');
    ...
    it.skip('should be a scallywag by default', function () {
        var pirate = new Pirate('Anne Bony');

        assert.equal(pirate.name, 'Anne Bonny');
        assert.equal(pirate.job, 'scallywag');
    });

    it.skip('should be have another job', function () {
    ...
    it.skip('should not be cured by default', function () {
    ...
    it.skip('should be able to rob ships', function () {
        var pirate = new Pirate('Grace OMally');

        assert.equal(pirate.robShip(), 'YAARR!');
    });
    ...
    it.skip('should be able to ift a curse for 300 booty', function () {
