...
describe('Sphinx', () => {
    ...
    it.skip('should have no name', () => {
        ...
        // NOTE: We will not ask you to write yourown test in a mod 1 assessment, but it is good practice to prepare for mod 2!
    });
    ...
    it.skip('should collect only three riddles', () => {
        ...
        const riddle3 = {
            riddle: 'What starts with \'e\' and ends with an \'e\' and contains one letter?',
            answer: 'An envelope'
        };
        const riddle4 = {
    ...
    it.skip('should eat the hero if their answer isn\'t correct for any riddles', () => {
        const sphinx = new Sphinx();
        const riddle1 = {
            riddle: 'What word becomes sorter when you add two letters to it?',
            answer: 'short'
        };
        const riddle2 = {
            riddle: 'How far can a fox run into a grove?',
    ...
    it.skip('should scream with rage if a gero gets all riddles correct', () => {
        const sphinx = new Sphinx();
        const riddle1 = {
            riddle: 'What word becomes shorter when you add two letters to it?',
            answer: 'short'
